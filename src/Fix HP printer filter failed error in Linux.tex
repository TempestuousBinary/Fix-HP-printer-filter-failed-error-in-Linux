...
\emph{\textcolor{Red}{Warning: please be aware that this is solution requires editing a config file in your root directory. If you're worried that will make the problem worse, either don't try it or do what I do: screenshot every step so you know how to go back and leave the file open so you can always undo the changes after testing.}}\\

\noindent Read the warning? What we're going to do is change the 


This solution comes courtesy of a thread on LinuxQuestions.org.\footnote{\url{https://www.linuxquestions.org/questions/linux-general-1/cups-unable-to-connect-to-server-184088/}}
...
This will change how CUPS works, but your computer probably (hopefully) won't explode. If you're wor
